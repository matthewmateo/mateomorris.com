// Portfolio Items - Updated June 29, 2024
function noop() { }
const identity = x => x;
function run(fn) {
    return fn();
...
// (117:10) {#each item.links as {link}}
function create_each_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*visible_items*/ 4 && t_value !== (t_value = /*link*/ ctx[10].label + "")) set_data(t, t_value);

			if (dirty & /*visible_items*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[10].url)) {
...
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*visible_items*/ 4 && !src_url_equal(img.src, img_src_value = /*item*/ ctx[7].thumbnail.url)) {
...
// (110:4) {#each visible_items as item (item.title)}
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*visible_items*/ 4 && t0_value !== (t0_value = /*item*/ ctx[7].date + "")) set_data(t0, t0_value);
			if (dirty & /*visible_items*/ 4 && t2_value !== (t2_value = /*item*/ ctx[7].title + "")) set_data(t2, t2_value);
			if (dirty & /*visible_items*/ 4 && raw_value !== (raw_value = /*item*/ ctx[7].description.html + "")) div0.innerHTML = raw_value;
...
function create_fragment(ctx) {
	...
	const get_key = ctx => /*item*/ ctx[7].title;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('show_all' in $$props) $$invalidate(5, show_all = $$props.show_all);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*show_all*/ 32) {
			$$invalidate(1, showing_all = show_all);
		}

		if ($$self.$$.dirty & /*items, showing_all*/ 18) {
			$$invalidate(2, visible_items = items.slice(0, showing_all ? items.length : 3));
		}
	};

	return [heading, showing_all, visible_items, props, items, show_all, click_handler];
}
