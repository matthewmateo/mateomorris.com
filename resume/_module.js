...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-eg61t7");
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-eg61t7");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-eg61t7");
		},
		m(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			attr(nav, "class", "svelte-eg61t7");
			attr(div0, "class", "desktop-nav svelte-eg61t7");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-eg61t7");
			attr(header, "class", "section-container svelte-eg61t7");
			attr(hr, "class", "svelte-eg61t7");
			attr(div2, "class", "section-container bottom svelte-eg61t7");
			attr(div3, "class", "component");
			attr(div4, "class", "section");
			attr(div4, "id", "section-f5621485-27db-44ed-ba3d-e03a8a7966aa");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	let div2;
	let h2;
	let t5_value = /*education*/ ctx[3].header + "";
	let t5;
	let t6;
	let p2;
	let t7_value = /*education*/ ctx[3].date + "";
	let t7;
	let t8;
	let p3;
	let t9_value = /*education*/ ctx[3].title + "";
	let t9;
	let t10;
	let p4;
	let t11_value = /*education*/ ctx[3].location + "";
	let t11;
	let t12;
	let div3;
	let t13;
	...
	return {
		...
		l(nodes) {
			...
			section = claim_element(div13_nodes, "SECTION", { class: true });
			...
			t0 = claim_text(p0_nodes, /*email*/ ctx[0]);
			p0_nodes.forEach(detach);
			t1 = claim_space(div0_nodes);
			p1 = claim_element(div0_nodes, "P", { class: true });
			var p1_nodes = children(p1);
			t2 = claim_text(p1_nodes, /*phone*/ ctx[1]);
		...
		h() {
			attr(p0, "class", "email");
			attr(p1, "class", "phone");
			attr(div0, "class", "contact-info svelte-1vdft3d");
			if (!src_url_equal(img.src, img_src_value = "" + (/*image*/ ctx[2].url + /*image*/ ctx[2].alt))) attr(img, "src", img_src_value);
			attr(div1, "class", "image svelte-1vdft3d");
			attr(h2, "class", "header svelte-1vdft3d");
			attr(p2, "class", "date");
			attr(p3, "class", "title svelte-1vdft3d");
			attr(p4, "class", "location svelte-1vdft3d");
			attr(div2, "class", "education-content");
			attr(div3, "class", "skills svelte-1vdft3d");
			attr(div4, "class", "talks svelte-1vdft3d");
			attr(div5, "class", "hobbies svelte-1vdft3d");
			attr(div6, "class", "education svelte-1vdft3d");
			attr(div7, "class", "left-column svelte-1vdft3d");
			attr(div8, "class", "header svelte-1vdft3d");
			attr(div9, "class", "experience svelte-1vdft3d");
			attr(div10, "class", "references svelte-1vdft3d");
			attr(div11, "class", "right-column svelte-1vdft3d");
			attr(div12, "class", "main-container svelte-1vdft3d");
			attr(section, "class", "section-container");
			attr(div13, "class", "component");
			attr(div14, "class", "section");
			attr(div14, "id", "section-e5cd4d2a-c0aa-41fb-8bd7-a566f0a8169d");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*email*/ 1) set_data(t0, /*email*/ ctx[0]);
			if (dirty & /*phone*/ 2) set_data(t2, /*phone*/ ctx[1]);

			if (dirty & /*image*/ 4 && !src_url_equal(img.src, img_src_value = "" + (/*image*/ ctx[2].url + /*image*/ ctx[2].alt))) {
				attr(img, "src", img_src_value);
			}

			if (dirty & /*education*/ 8 && t5_value !== (t5_value = /*education*/ ctx[3].header + "")) set_data(t5, t5_value);
			if (dirty & /*education*/ 8 && t7_value !== (t7_value = /*education*/ ctx[3].date + "")) set_data(t7, t7_value);
			if (dirty & /*education*/ 8 && t9_value !== (t9_value = /*education*/ ctx[3].title + "")) set_data(t9, t9_value);
			if (dirty & /*education*/ 8 && t11_value !== (t11_value = /*education*/ ctx[3].location + "")) set_data(t11, t11_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('education' in $$props) $$invalidate(3, education = $$props.education);
	};

	return [email, phone, image, education];
}
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div3, "id", "section-b3ddd0aa-64c3-4463-a223-c0144d457712");
		},
		m(target, anchor) {
...
class Component$4 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$3, create_fragment$4, safe_not_equal, { heading: 0, email: 1, social_links: 2 });
	}
}
...
function create_fragment$5(ctx) {
	...
	component_2 = new Component$3({
			props: {
				email: "E: mateo@me.com",
				phone: "P: (703) 789-3433",
				image: {
					"alt": "",
